...
def Create(context):
    context.driver.find_element(By.XPATH,
                                "/html/body/div[4]/div/div/div/div/div/div[2]/div/form/div[5]/button[1]").click()


    time.sleep(1.5)
    try:
        text = context.driver.find_element(By.XPATH, "/html/body/div[4]/div/div/div/div/div/div[2]/div/form/div[5]/button[1]/div/div").text
    except:
         context.driver.close()
         assert False, "Test Failed: Create Button not clicked"
    if text == "Create":
         assert True, "Create button is pressed"
    if text == "Failed":
...
def Done(context):
    ...
    time.sleep(1.5)
    try:
        text = context.driver.find_element(By.XPATH, "/html/body/div[4]/div/div/div/div/div/div[3]/div/button/div/div").text
    except:
        context.driver.close()
        assert False, "Test Failed: Done Button not found"
    if text == "Done":
        assert True, "Done button is clicked"

@then(u'New user will be created')
def NewUser(context):
...
def Groups(context):
    context.driver.find_element(By.XPATH,
                                "//*[@id=\"root\"]/div/div/main/div/div[2]/div[1]/ul/li[2]/a").click()
...
def AdministratorGroup(context):
    context.driver.find_element(By.XPATH,
                                "//*[@id=\"root\"]/div/div/main/div/div[2]/div[2]/div/table/tbody/tr[1]/td[1]/a").click()
...
def AddMemberbutton(context):
    context.driver.find_element(By.XPATH,
                                "//*[@id=\"root\"]/div/div/main/div/div[2]/div[2]/div/section/div/button").click()
...
@when(u'I enter the name of the created user as "{firstname}" ')
def Entername(context,firstname):
    context.driver.find_element(By.XPATH, "//*[@id=\"root\"]/div/div/main/div/div[2]/div[2]/div/table/tbody/tr[1]/td/div/input").send_keys(firstname)
    time.sleep(1.5)
    context.driver.find_element(By.XPATH,
                                "//*[@id=\"tippy-3\"]/div/div/div/div/div").click()

    time.sleep(1.5)
    try:
        text = context.driver.find_element(By.XPATH,
                                           "//*[@id=\"tippy-3\"]/div/div/div/div/div/span[2]").text
    except:
        context.driver.close()
        assert False, "Test Failed: first name not found"
    if text == firstname:
        assert True, "Clicked firstname successfully"

@when(u'I click on the Add button')
def AddButton(context):
    context.driver.find_element(By.XPATH,
                                "//*[@id=\"root\"]/div/div/main/div/div[2]/div[2]/div/table/tbody/tr[1]/td/div/button").click()
